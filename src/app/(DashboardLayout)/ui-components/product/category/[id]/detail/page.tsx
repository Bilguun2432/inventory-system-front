...
const pagePaths = [
  { title: "Ангилал", url: "/product/category" },
  { title: "Дэлгэрэнгүй" },
];
...
export default function ProductCategoryDetail() {
  ...
  function createNewClick() {
    showModal(
      "Create new ProductCategory Translate English",
      <TranslationForm onComplete={onMutateComplete} id2={id} locale={""} />,
    );
  }
